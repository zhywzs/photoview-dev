...
export interface AlbumGalleryFields_media_thumbnailSmall {
  __typename: "MediaURL";
  /**
   * URL for previewing the image
   */
...
export interface AlbumGalleryFields_media_thumbnailTiny {
  __typename: "MediaURL";
  /**
   * URL for previewing the image
   */
...
export interface AlbumGalleryFields_media {
   ...
   */
  thumbnailSmall: AlbumGalleryFields_media_thumbnailSmall | null;
  /**
   * URL to display the media in a tiny resolution (max 128px), used for ultra dense gallery views
   */
  thumbnailTiny: AlbumGalleryFields_media_thumbnailTiny | null;
  /**
