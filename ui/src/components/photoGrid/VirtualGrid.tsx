...
type VirtualGridProps<T> = {
  ...
  /**
   * The layer is displayed with `translateY(offset) scale(scale)` about
   * `viewportOriginY` (in the container's own coordinates). The virtualizer
   * needs to know this to render the tiles that end up on screen.
   */
